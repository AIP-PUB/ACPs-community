...
class AipExecutor(TaskExecutor):
    ...
    async def _execute_one_notification_partner(
        ...
        if notification_executor is None:
            raise RuntimeError("notification executor is required for notification partner execution")
        ...
        terminal_future = notification_executor.register_task_future(task_id)
        ...
        try:
            ...
            await notification_executor.start_for_partner(
            ...
            notification_executor.cancel_task_future(task_id)
            return aic, PartnerExecutionResult(
                partner_aic=aic,
                dimension_id=dim_id,
